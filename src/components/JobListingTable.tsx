...
import JobFiltersBar from './job-table/JobFiltersBar';
import JobTableHeader from './job-table/JobTableHeader';
import JobTableRow from './job-table/JobTableRow';
import NoJobsFound from './job-table/NoJobsFound';
...
export default function JobListingTable({ 
  ...
  const handleExportExcel = async () => {
    ...
    const rows = sortedJobs.map(job => [
      ...
      job.remote_policy || '',
      job.possible_salary || '',
      job.start_date && isValidDate(job.start_date) ? formatDate(job.start_date, "yyyy-MM-dd") : "",
